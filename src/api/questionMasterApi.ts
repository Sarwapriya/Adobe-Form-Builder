...
/** Which generation path produced a QuestionMasterVersion — 'form_builder' (the
 * original, unchanged Form-Initiator-based process) or 'excel_upload' (the additive
 * one sourced from submitted workbook uploads instead). */
